...
/*   Updated: 2025/05/11 16:59:13 by tmuranak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool arg_check(int number_of_philosophers, int time_to_die, int time_to_eat, int time_to_sleep)
{
	return (
...
bool set_args(int argc, char *argv[], t_info_table *arg_info)
{
	...
	if (!arg_check(number_of_philosophers, time_to_die, time_to_eat, time_to_sleep))
		return (false);
	if (argc == 5)
	...
	return (argc == 5 || (argc == 6 && number_of_times_each_philosopher_must_eat >= 0));
}
